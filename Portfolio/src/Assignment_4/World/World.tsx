import { Mesh, PerspectiveCamera, Plane, Quaternion, Raycaster, Scene, SpotLight, Vector2, Vector3, WebGLRenderer, AxesHelper } from 'three';
import { createCamera } from "./components/camera.js";
import { createScene } from "./components/scene.js";
import { createRenderer } from "./systems/renderer.js";
import { Resizer } from "./systems/Resizer.js";
import { createCube } from './components/cube.js';
import { createAmbientLight, createDirectionalLight, createSpotLight } from './components/lights.js';
...
class World {
  ...
  render(): void {
    ...
    this.spotLight.target.position.set(this.cube.position.x, this.cube.position.y, this.cube.position.z);
